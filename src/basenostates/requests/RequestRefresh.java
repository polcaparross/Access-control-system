...
public class RequestRefresh implements Request {
  ...
  // Also this is used to paint
  // the simulator when the page is loaded,
  // and to display
  // doors and readers after passing
  // from locked to propped or
  // propped to locked, pressing the Refresh
  // Request button of the simulator.
  ...
  // repaint the readers
  public void process() {
    for (Door door : DirectoryDoorsAndAreas.getAllDoors()) {
